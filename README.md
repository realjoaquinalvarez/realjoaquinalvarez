...
Self-taught engineer from Paraguay. Went from zero to the only frontend engineer at a YC startup in seven months. Now building Talkeo, solo, end to end.
...
**Stack:** TypeScript · Next.js · React · Python · FastAPI · WebRTC · AWS · PostgreSQL · pgvector · Swift
